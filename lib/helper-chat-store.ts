...
export function helperAssistantReply(userInput: string): string {
  const help: Record<string, string> = {
    navigation: "Use the left sidebar to explore Media Ecosystem, Benchmarks, Investment, and Consumer insights. The Account group contains your Profile.",
    chat: "For full conversation threads, click ‘Ask Anything’ in the main menu to open the full chat.",
    profile: "Update your name, email, avatar, and password under Account → Profile. The image is saved locally.",
